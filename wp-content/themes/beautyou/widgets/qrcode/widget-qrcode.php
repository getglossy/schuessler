...
class themerex_qrcode_widget extends WP_Widget {
	...
	function themerex_qrcode_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget('qrcode-widget', __('ThemeREX - QRCode generator', 'themerex'), $widget_ops, $control_ops);
	}
	...
	function form($instance) {
		...
		<div class="widget_qrcode">
        	<div class="qrcode_tabs">
                ...
                <div id="tab_settings" class="tab_content tab_settings">
                    <p>
                        ...
                        <input class="fld_title" onfocus="initQRCode()" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo esc_attr($instance['title']); ?>" style="width:100%;" />
                    </p>
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('show_what'); ?>_1"> <?php _e('Personal VCard', 'themerex'); ?></label>
                        ...
                        <label for="<?php echo $this->get_field_id('show_what'); ?>_0"> <?php _e('Any text', 'themerex'); ?></label>
                    </p>
                    <p>
                        ...
                        <label for="<?php echo $this->get_field_id('show_personal'); ?>"><?php _e('Show data under QR Code:', 'themerex'); ?></label>
                    </p>
                    <p>
                        <label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width:', 'themerex'); ?></label>
                        <input onmousedown="initQRCode()" onfocus="initQRCode()" id="<?php echo $this->get_field_id('width'); ?>" name="<?php echo $this->get_field_name('width'); ?>" value="<?php echo esc_attr($instance['width']); ?>" style="width:100%;" class="fld_width" />
                    </p>
                    <p>
                        <label for="<?php echo $this->get_field_id('color'); ?>"><?php _e('Color:', 'themerex'); ?></label>
                        <input onmousedown="initQRCode()" onfocus="initQRCode()" id="<?php echo $this->get_field_id('color'); ?>" name="<?php echo $this->get_field_name('color'); ?>" value="<?php echo esc_attr($instance['color']); ?>" style="width:100%; background-color:<?php echo $instance['color']; ?>" class="iColorPicker fld_color" />
                    </p>
                    <p>
                        <label for="<?php echo $this->get_field_id('bg'); ?>"><?php _e('Bg color:', 'themerex'); ?></label>
                        <input onmousedown="initQRCode()" onfocus="initQRCode()" id="<?php echo $this->get_field_id('bg'); ?>" name="<?php echo $this->get_field_name('bg'); ?>" value="<?php echo esc_attr($instance['bg']); ?>" style="width:100%; background-color:<?php echo $instance['bg']; ?>" class="iColorPicker fld_bg" />
                    </p>
                </div>
                <div id="tab_fields" class="tab_content tab_personal">
                    <p>
                        <label for="<?php echo $this->get_field_id('ulname'); ?>"><?php _e('Last name:', 'themerex'); ?></label>
                        <input class="fld_ulname" id="<?php echo $this->get_field_id('ulname'); ?>" name="<?php echo $this->get_field_name('ulname'); ?>" value="<?php echo esc_attr($instance['ulname']); ?>" style="width:100%;" />
                    </p>
                    
                    <p>
                        <label for="<?php echo $this->get_field_id('ufname'); ?>"><?php _e('First name:', 'themerex'); ?></label>
                        <input class="fld_ufname" id="<?php echo $this->get_field_id('ufname'); ?>" name="<?php echo $this->get_field_name('ufname'); ?>" value="<?php echo esc_attr($instance['ufname']); ?>" style="width:100%;" />
                    </p>
                    
                    <p>
                        <label for="<?php echo $this->get_field_id('ucompany'); ?>"><?php _e('Company:', 'themerex'); ?></label>
                        <input class="fld_ucompany" id="<?php echo $this->get_field_id('ucompany'); ?>" name="<?php echo $this->get_field_name('ucompany'); ?>" value="<?php echo esc_attr($instance['ucompany']); ?>" style="width:100%;" />
                    </p>
                    
                    <p>
                        <label for="<?php echo $this->get_field_id('uphone'); ?>"><?php _e('Phone:', 'themerex'); ?></label>
                        <input class="fld_uphone" id="<?php echo $this->get_field_id('uphone'); ?>" name="<?php echo $this->get_field_name('uphone'); ?>" value="<?php echo esc_attr($instance['uphone']); ?>" style="width:100%;" />
                    </p>
           
                    <p>
                        <label for="<?php echo $this->get_field_id('uaddr'); ?>"><?php _e('Address:', 'themerex'); ?></label>
                        <input class="fld_uaddr" id="<?php echo $this->get_field_id('uaddr'); ?>" name="<?php echo $this->get_field_name('uaddr'); ?>" value="<?php echo esc_attr($instance['uaddr']); ?>" style="width:100%;" />
                    </p>
                    
                    <p>
                        <label for="<?php echo $this->get_field_id('ucity'); ?>"><?php _e('City:', 'themerex'); ?></label>
                        <input class="fld_ucity" id="<?php echo $this->get_field_id('ucity'); ?>" name="<?php echo $this->get_field_name('ucity'); ?>" value="<?php echo esc_attr($instance['ucity']); ?>" style="width:100%;" />
                    </p>
                    
                    <p>
                        <label for="<?php echo $this->get_field_id('upostcode'); ?>"><?php _e('Post code:', 'themerex'); ?></label>
                        <input class="fld_upostcode" id="<?php echo $this->get_field_id('upostcode'); ?>" name="<?php echo $this->get_field_name('upostcode'); ?>" value="<?php echo esc_attr($instance['upostcode']); ?>" style="width:100%;" />
                    </p>
                    
                    <p>
                        <label for="<?php echo $this->get_field_id('ucountry'); ?>"><?php _e('Country:', 'themerex'); ?></label>
                        <input class="fld_ucountry" id="<?php echo $this->get_field_id('ucountry'); ?>" name="<?php echo $this->get_field_name('ucountry'); ?>" value="<?php echo esc_attr($instance['ucountry']); ?>" style="width:100%;" />
                    </p>
            
                    <p>
                        <label for="<?php echo $this->get_field_id('uemail'); ?>"><?php _e('E-mail:', 'themerex'); ?></label>
                        <input class="fld_uemail" id="<?php echo $this->get_field_id('uemail'); ?>" name="<?php echo $this->get_field_name('uemail'); ?>" value="<?php echo esc_attr($instance['uemail']); ?>" style="width:100%;" />
                    </p>
            
                    <p>
                        <label for="<?php echo $this->get_field_id('usite'); ?>"><?php _e('Web Site URL:', 'themerex'); ?></label>
                        <input class="fld_usite" id="<?php echo $this->get_field_id('usite'); ?>" name="<?php echo $this->get_field_name('usite'); ?>" value="<?php echo esc_attr($instance['usite']); ?>" style="width:100%;" />
                    </p>
				</div>
                <div id="tab_text" class="tab_content tab_text">
                    <p>
                        <label for="<?php echo $this->get_field_id('fld_text'); ?>"><?php _e('Text to show as QR Code:', 'themerex'); ?></label>
            ...
            <input class="fld_uid" id="<?php echo $this->get_field_id('uid'); ?>" name="<?php echo $this->get_field_name('uid'); ?>" value="<?php echo esc_attr($instance['uid']); ?>" type="hidden" />
            <input class="fld_urev" id="<?php echo $this->get_field_id('urev'); ?>" name="<?php echo $this->get_field_name('urev'); ?>" value="<?php echo esc_attr($instance['urev']); ?>" type="hidden" />
    
            <p>
                <input class="fld_button_draw" id="<?php echo $this->get_field_id('button_draw'); ?>" name="<?php echo $this->get_field_name('button_draw'); ?>" value="<?php echo esc_attr(__('Update', 'themerex')); ?>" type="button" />
                ...
                <label for="<?php echo $this->get_field_id('auto_draw'); ?>"> <?php _e('Auto', 'themerex'); ?></label>
            </p>
            <input class="fld_image" id="<?php echo $this->get_field_id('image'); ?>" name="<?php echo $this->get_field_name('image'); ?>" value="" type="hidden" />
            <div id="<?php echo $this->get_field_id('qrcode_image'); ?>" class="qrcode_image"><img src="<?php echo $instance['image']; ?>" alt="" /></div>
