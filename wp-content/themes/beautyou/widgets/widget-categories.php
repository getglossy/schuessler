...
class themerex_categories_widget extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function themerex_categories_widget() {
		/* Widget settings. */
		...
		/* Create the widget. */
		$this->WP_Widget( 'themerex-subcategories-widget', __('AxiomThemes - Subcategories list', 'themerex'), $widget_ops, $control_ops );
	}
				...
				/* <![CDATA[ */
					jQuery('.widget_subcategories select').change(function() {
						...
						if ( dropdown.options[dropdown.selectedIndex].value > 0 ) {
							location.href = "<?php echo esc_js(home_url()); ?>/?cat="+dropdown.options[dropdown.selectedIndex].value;
						}
					});
				/* ]]> */
				</script>
