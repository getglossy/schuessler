...
THEMEREX_SEND_ORDER_COMPLETE  = "<?php echo addslashes(__('Thank you! We\'ll be in touch.', 'themerex')); ?>";
...
// Css Animation
var THEMEREX_css_animation = <?php echo get_custom_option('css_animation')=='yes' ? 'true' : 'false'; ?>;
...
// Fix main menu
var THEMEREX_menuFixed = <?php echo get_custom_option('menu_position')=='fixed' ? 'true' : 'false'; ?>;
