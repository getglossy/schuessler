...
if (get_custom_option("show_post_related") == 'yes') {
	...
	?>
		<section class="relatedWrap<?php echo get_custom_option("show_post_comments") == 'yes' ? ' hrShadow' : ''; ?>">
			<h3><?php _e('Recommended Posts', 'themerex'); ?></h3>
			<div class="relatedPostWrap">
				<div class="columnsWrap <?php echo get_custom_option("post_related_style") == 'no' ? ' no_indent_style columnsFloat' : ' indent_style'; ?>">
				<?php
				$i=0;
