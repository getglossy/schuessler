...
define( 'NOTIFIER_THEME_NAME', 'Beautyou' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'beautyou' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_beautyou.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
?>
	...
	<div class="wrap">
		...
		<div id="theme_update_instructions">
		    ...
		    <p><?php _e('To update the Theme, login to <a href="'.esc_url('http://www.themeforest.net/').'">ThemeForest</a>, head over to your <strong>downloads</strong> section and re-download the theme like you did when you bought it.' ,'themerex'); ?></p>
	    ...
	    <div class="theme_update_changelog"><?php echo esc_html($xml->changelog); ?></div>
