...
$THEMEREX_shortcodes_margin_top_int = array(
	"id" => "top",
	"title" => __("Top margin", "themerex"),
	"divider" => true,
	"value" => "",
...
$THEMEREX_shortcodes_margin_bottom_int = array(
	"id" => "bottom",
	"title" => __("Bottom margin", "themerex"),
	"value" => "",
	"type" => "text"
...
$animation_all = get_custom_option('css_animation')=='yes' ? 'yes' : 'no';
$THEMEREX_shortcodes_animations = array(
	"id" => "animation",
	"title" => __("Animation", "themerex"),
	"desc" => __("Select animation while object enter in the visible area of page", "themerex"),
	"value" => "",
	"type" => "select",
	"options" => themerex_get_list_animations_in()
);
...
$THEMEREX_shortcodes = array(
	...
	array(
		...
		"params" => array(
			...
			$THEMEREX_shortcodes_animations,
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "author",
				"title" => __("Author content", "themerex"),
				"desc" => __("Author content", "themerex"),
				"rows" => 2,
				"value" => "",
				"type" => "textarea"
			),
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Select posts only with videos, audios, thumbs or galleries", "themerex"),
				"value" => "no",
				"type" => "select",
			...
			array(
				"id" => "readmore",
				"title" => __("Read More - text", "themerex"),
				"desc" => __("Text for Read More (for related style)", "themerex"),
				"value" => "",
				"type" => "text"
			),
			THEMEREX_shortcodes_width(),
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"dir" => "horizontal",
				"options" => array(
					'global' => __('Color 1', 'themerex'),
					'accent_1' => __('Color 2', 'themerex'),
					'accent_2' => __('Color 3', 'themerex'),
					'accent_3' => __('Color 4', 'themerex'),
					'dark'   => __('Dark', 'themerex'),
					'gray'  => __('Gray', 'themerex'),
					'border' => __('Border (color 1 hover)', 'themerex'),
					'border_1' => __('Border', 'themerex')
				)
			),
			array(
				"id" => "size",
			...
			array(
				"id" => "block",
				"title" => __("Display ellement", "themerex"),
				"desc" => __("Display as a block ellement", "themerex"),
				"value" => "yes",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			),
	...
	array(
		...
		"children" => array(
			...
			"params" => array(
				...
				array(
					"id" => "bg_resize",
					"title" => __("Stretch the background image", "themerex"),
					"desc" => __("Stretch the background image in responsive version", "themerex"),
					"divider" => false,
					"value" => "yes",
					"type" => "switch",
					"options" => $THEMEREX_shortcodes_yes_no
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "style",
				"title" => __("Style contact form", "themerex"),
				"desc" => __("Style contact form", "themerex"),
				"value" => "main",
				"type" => "checklist",
				"options" => array(
					'main' => __('Main', 'themerex'),
					'order' => __('Order', 'themerex')
				)
			),
			array(
				"id" => "style_color",
				"title" => __("Color style", "themerex"),
				"desc" => __("Color style contact form", "themerex"),
				"value" => "dark",
				"type" => "checklist",
				"options" => array(
					'dark' => __('Dark', 'themerex'),
			...
			array(
				"id" => "dots",
				"title" => __("Points", "themerex"),
				"desc" => __("Show points (for Order style)", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Transforming text to uppercase", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			...
			array(
				"id" => "main",
				"title" => __("Auto width", "themerex"),
				"desc" => __("Auto width container", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			...
			array(
				"id" => "text_styling",
				"title" => __("Stylisation text", "themerex"),
				"desc" => __("Stylisation text (italic)", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			...
			array(
				"id" => "align",
				"title" => __("Alignment", "themerex"),
				"desc" => __("Align text to left, center or right", "themerex"),
				"divider" => true,
				"value" => "none",
				"type" => "checklist",
				"dir" => "horizontal",
	...
	array(
		...
		"desc" => __("Insert posts (events) from desired categories or directly from ids", "themerex"),
		"id" => "trx_events",
		"decorate" => false,
		"container" => false,
		"params" => array(
			...
			array(
				"id" => "cat",
				"title" => __("Category ID", "themerex"),
				"desc" => __("Category ID", "themerex"),
				"value" => "",
				"type" => "text"
			),
			array(
			...
			array(
				"id" => "col",
				"title" => __("Column", "themerex"),
				"desc" => __("How many columns will be displayed?", "themerex"),
				"value" => 3,
				"min" => 1,
				"max" => 4,
				"type" => "spinner"
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "link",
				"title" => __("Icon as links", "themerex"),
				"desc" => __("Show icon as links", "themerex"),
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			),
			array(
				"id" => "url",
				"title" => __('Icon link', "themerex"),
				"desc" => __("Set link", "themerex"),
				"dependency" => array(
					'link' => 'yes'
				),
				"value" => "",
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Image as a reference", "themerex"),
				"value" => "off",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_on_off
			),
			...
			array(
				"id" => "url_color",
				"title" => __("URL for hover image file (if Link)", "themerex"),
				"desc" => __("Select or upload image or write URL from other site", "themerex"),
				"readonly" => false,
				"value" => "",
				"dependency" => array(
			...
			array(
				"id" => "increment",
				"title" => __("Increment", "themerex"),
				"desc" => __("Image enlargement on hover", "themerex"),
				"value" => "yes",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			),
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "border_style",
				"title" => __("Style border", "themerex"),
				"desc" => __("Style border", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			...
			array(
				"id" => "box",
				"title" => __("Box", "themerex"),
				"desc" => __("Page fill whole window with centered content", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "style_bar",
				"title" => __("Skills style", "themerex"),
				"desc" => __("Select style of skills items (only for type=Bar)", "themerex"),
				"dependency" => array(
					'type' => array('bar')
				),
				"value" => 1,
		...
		"children" => array(
			...
			"params" => array(
				...
				array(
					"id" => "style_bar",
					"title" => __("Skills item style", "themerex"),
					"desc" => __("Select style for the current skills item (only for type=Bar)", "themerex"),
					"dependency" => array(
						'type' => array('bar')
					),
					"value" => 1,
	...
	array(
		...
		"params" => array_merge(array(
			...
			array(
				"id" => "alias",
				"title" => __("Revolution slider alias ID", "themerex"),
				"desc" => __("Alias for Revolution slider ID", "themerex"),
				"dependency" => array(
					'engine' => array('revo')
				),
				"divider" => true,
	...
	array(
		...
		"params" => array(
				...
				array(
					"id" => "autoheight",
					"title" => __("Auto Height", "themerex"),
					"desc" => __("Height depending on the contents.", "themerex"),
					"divider" => true,
					"value" => "no",
					"type" => "switch",
					"options" => $THEMEREX_shortcodes_yes_no
			...
			"children" => array(
				"title" => __("Slide", "themerex"),
				"desc" => __("Slider item", "themerex"),
				"id" => "trx_text_slider_item",
				"container" => true,
				"params" => array(
					array(
						"id" => "_content_",
						"title" => __("Slide content", "themerex"),
						"desc" => __("Current Slide content", "themerex"),
						"divider" => true,
						"rows" => 4,
						"value" => "",
						"type" => "textarea"
	...
	array(
		...
		"params" => array(
			array(
				...
				"type" => "select",
				"options" => array(
					"no_indentation" => __('Without indentation', 'themerex'),
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "padding",
				"title" => __("Use padding", "themerex"),
				"desc" => __("Use padding for content", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
			...
			array(
				"id" => "bg_color",
				"title" => __("Background color", "themerex"),
				"desc" => __("Any background color for tab content", "themerex"),
				"value" => "",
				"type" => "color"
			),
			THEMEREX_shortcodes_width(),
		...
		"children" => array(
			...
			"params" => array(
				...
				array(
					"id" => "link",
					"title" => __("Link", "themerex"),
					"desc" => __("Team member's page link", "themerex"),
					"value" => "#",
					"type" => "text"
				),
				array(
					"id" => "icon",
					"title" => __('Link icon',  'themerex'),
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "icon_color",
				"title" => __("Icon's color", "themerex"),
				"desc" => __("Icon's color (if style=iconed)", "themerex"),
				"dependency" => array(
					'style' => array('iconed')
				),
				"value" => "",
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "show_user",
				"title" => __("Show Twitter Username", "themerex"),
				"desc" => __("Show Twitter Username", "themerex"),
				"value" => "on",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_on_off
			),
	...
	array(
		...
		"params" => array(
			...
			THEMEREX_shortcodes_width(),
			THEMEREX_shortcodes_height(),
			$THEMEREX_shortcodes_margin_top_int,
			$THEMEREX_shortcodes_margin_bottom_int,
			$THEMEREX_shortcodes_margin_left,
			$THEMEREX_shortcodes_margin_right,
			$THEMEREX_shortcodes_id,
			$THEMEREX_shortcodes_class
