...
<div class="booking_text_center booking_width_100p booking_margin_t_100">
    <div style="font-size: 30px;"><?php echo $bookingLangObj->getLabel("PAYPAL_CONFIRM_NOT_CONFIRMED_1"); ?></div>
    <div style="font-size: 20px; margin-top: 20px;"><?php echo $bookingLangObj->getLabel("PAYPAL_CONFIRM_NOT_CONFIRMED_2"); ?></div>
