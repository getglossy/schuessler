...
include '../common.php';
@session_start();
$fp = fopen(ABSPATH . "wp-content/plugins/wp-booking-calendar/admin/ajax/reservation.csv", 'w+');
...
$arrayReservations = $bookingListObj->getReservationsList($_SESSION["qryReservationsFilterString"],"",$_GET["calendar_id"]);
