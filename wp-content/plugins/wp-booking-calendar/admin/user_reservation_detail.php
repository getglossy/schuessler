    ...
    <div class="booking_margin_t_20">
            ...
            <script language="javascript" type="text/javascript">
                ...
                function printDiv(div) {
					div ="detail_page";
                    var includeCss = '<style>#detail_page {margin:auto;width:920px;background-color:#F6F6F5;border: 1px solid #CCCCCC;margin-top:15px;margin-bottom:0px;height:auto;}#title_row_detail {padding-left: 10px;width: 350px;height: 35px;float: left;line-height: 35px;font-weight:bold;}#row_detail {width:560px;height:35px;line-height: 35px;float: left;}.booking_cleardiv { clear: both; }</style>';
                    var printContent = '<html><head><title>Print reservation</title>'+includeCss+'</head><body><div id='+div+'>'+$wbc('#'+div).html()+'</div></body></html>';
                    var winToPrint = window.open('','Print reservation','left=0,top=0,width=1,height=1,toolbar=0,scrollbars=0,status=0');
                    winToPrint.document.write(printContent);
                    
					$wbc(winToPrint.document).ready(function() {
						winToPrint.close();
                    	winToPrint.print();
					});
            ...
            <div class="booking_margin_t_20 booking_bg_f6f booking_border_1 booking_border_solid booking_border_ccc booking_padding_10">
                <div class="booking_float_right">
                    <div class="booking_float_left"><a href="?page=wp-booking-calendar-orders" class="booking_float_left booking_margin_l_20 booking_mark_333 booking_pointer booking_font_bold"><?php echo $bookingLangObj->getLabel("RESERVATION_CLOSE"); ?></a></div>
            ...
            <div class="booking_bg_f6f booking_border_1 booking_border_solid booking_border_ccc booking_margin_t_20" id="detail_page">
				...
				if(in_array("reservation_surname",$bookingSettingObj->getVisibleFields())) { 
					?>
					<div class="booking_bg_fff booking_float_left booking_width_30p booking_height_30 booking_line_30 booking_padding_l_1p"><?php echo $bookingLangObj->getLabel("RESERVATION_SURNAME_LABEL"); ?></div>
